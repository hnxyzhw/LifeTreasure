//
//  RequestServerFactory.swift
//  LifeTreasure
//
//  Created by andson-zhw on 17/3/13.
...
private let NetworkRequestShareInstance = RequestServerFactory()

class RequestServerFactory {
    class var sharedInstance : RequestServerFactory {
